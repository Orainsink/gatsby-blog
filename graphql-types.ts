...
export type FileFieldsEnum = 
  ...
  | 'childMarkdownRemark___frontmatter___copyright'
  | 'childMarkdownRemark___frontmatter___permalink'
  | 'childMarkdownRemark___frontmatter___top'
...
export type MarkdownRemarkFrontmatterFilterInput = {
  ...
  description?: Maybe<StringQueryOperatorInput>;
  copyright?: Maybe<BooleanQueryOperatorInput>;
  permalink?: Maybe<IntQueryOperatorInput>;
...
export type BioQueryQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixedFragment> }> }>, site?: Maybe<{ siteMetadata?: Maybe<{ author?: Maybe<Pick<SiteSiteMetadataAuthor, 'name' | 'summary'>>, social?: Maybe<Pick<SiteSiteMetadataSocial, 'github'>> }> }> };
...
export type Unnamed_1_Query = { site?: Maybe<{ siteMetadata?: Maybe<(
      ...
      & { social?: Maybe<Pick<SiteSiteMetadataSocial, 'github'>> }
    )> }> };
