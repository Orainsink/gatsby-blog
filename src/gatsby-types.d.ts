...
declare namespace Queries {
  ...
  type getMoogleFileQuery = {
    readonly file: { readonly publicURL: string | null } | null;
  };

  type getPageDataQueryVariables = Exact<{ [key: string]: never }>;

  type getPageDataQuery = {
    readonly site: {
      readonly siteMetadata: { readonly title: string | null } | null;
    } | null;
    readonly allMdx: {
